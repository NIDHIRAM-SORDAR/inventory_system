...
class LocalAuthState(rx.State):
    ...
    def do_logout(self):
        ...
        with rx.session() as session:
            for auth_session in session.exec(
                ...
                LocalAuthSession.session_id
                session.delete(auth_session)
            session.commit()
        self.auth_token = ""
        self.reset()  # Reset state after logout
    ...
    def _login(
        ...
        """Create a LocalAuthSession for the given user_id."""
        ...
        # Explicitly set auth_token
        new_token = self.router.session.client_token
        self.auth_token = new_token  # Direct assignment, no conditional
